package com.example.qrscannerappcamerax;
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    // Code that should run on Marshmallow or higher
                    // This could include requesting runtime permissions, which was introduced in Marshmallow.
                    ...
                    // Code that should run on versions lower than Marshmallow
                }
